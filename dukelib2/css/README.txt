...
To use these stylesheets, rename the files and dukelib2 with the name of your theme.
...
dukelib2-alpha-default-narrow.css  
...
dukelib2-alpha-default-normal.css
...
dukelib2-alpha-default-wide.css
